...
import "../../components/main.css"; // Custom CSS for animations and styles
import projectimg from "../../assets/images/pj1.png"; // Ensure this path is correct
import useProjectCRUD from "../../hooks/Project/useProjectCRUD"; // Update with correct path
import useTeamCRUD from "../../hooks/Team/useTeamCRUD"; // Update with correct path
...
const ProjectPage = () => {
  ...
  useEffect(() => {
    handleFetchProjects();
    handleFetchTeams();
  }, [handleFetchProjects, handleFetchTeams]);
