...
const HomePage = () => {
  ...
  return (
    <Container fluid className="vh-100 d-flex align-items-center justify-content-center home-container">
      <Row className="w-100 justify-content-center">
        <Col md={4} className="d-flex flex-column justify-content-center align-items-center p-4">
          <Card className="w-100 task-manager-card">
            <CardBody className="text-center">
              <h1 className="display-9 mb-2">Manage all your tasks in one place</h1>
            </CardBody>
          </Card>
