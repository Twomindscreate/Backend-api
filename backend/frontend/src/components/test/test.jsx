...
import { Card, Header, Button, Form, Message } from "semantic-ui-react";
import { useNavigate } from "react-router-dom";
import axios from "axios";
import { toast } from "react-toastify";
import $ from "jquery";
import "./test.css"; // Import your custom CSS
...
const OTPVerification = () => {
  ...
  useEffect(() => {
    // Trigger the horizontal flip transition on the OTP card
    $(".otp-card").transition("horizontal flip");
  }, []);
    ...
    <div className="otp-wrapper">
      <Card centered className="otp-card">
        <Header as="h2" textAlign="center">
          <Icon name="key" className="icons" /> OTP Verification
        </Header>
