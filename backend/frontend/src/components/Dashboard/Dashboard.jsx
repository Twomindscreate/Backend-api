...
const dummyData = {
  ...
  tableData: [
    { project: 'Project A', team: 'Team A', startDate: '2023-01-01', endDate: '2023-06-01', status: 'Completed' },
    { project: 'Project B', team: 'Team B', startDate: '2023-02-01', endDate: '2023-07-01', status: 'In Progress' },
    { project: 'Project C', team: 'Team C', startDate: '2023-03-01', endDate: '2023-08-01', status: 'Pending' },
  ],
  treeData: {
    name: 'Manager',
    children: [
